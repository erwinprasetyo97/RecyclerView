package com.example.er.myrecycleview;
...
/**
 * Created by Er on 4/14/2018.
 */

public class ListPresidentAdapater extends RecyclerView.Adapter<ListPresidentAdapater.CategoryViewHolder>{
    ...
    public ListPresidentAdapater(Context context) {
